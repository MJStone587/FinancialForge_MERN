...
const Receipt = () => {
  ...
  const submitHandler = async () => {
    ...
    const response = await fetch('https://financialforge-mern.onrender.com/catalog/expense/create', {
      method: 'POST',
  ...
  const updateHandler = async () => {
    ...
    const response = await fetch('https://financialforge-mern.onrender.com/catalog/expense/' + expID, {
      method: 'POST',
      body: JSON.stringify(expense),
      headers: { 'Content-Type': 'application/json' },
    });
